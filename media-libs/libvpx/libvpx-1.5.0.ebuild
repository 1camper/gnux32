...
src_prepare() {
	...
	epatch "${FILESDIR}/${PV}/0008-x86-fix-building-with-enable-pic.patch"
	epatch "${FILESDIR}/${PV}/0009-x32-support-x86_abi_support.asm.patch"
	epatch "${FILESDIR}/${PV}/0010-x32-support-x86_abi_support.asm-users.patch"
	epatch "${FILESDIR}/${PV}/0011-x32-support-x86inc.asm.patch"
	epatch "${FILESDIR}/${PV}/0012-x32-support-x86inc.asm-users.patch"
}
