...
src_prepare() {
	...
	epatch "${FILESDIR}/${PV}/0012-rebase-1.7.0_x32-1.6.1_x32-extra-fix-unaligned-memor.patch"
	epatch "${FILESDIR}/${PV}/0013-rebase-v1.7.0_x32-v1.6.1_x32-extra-x32-support.patch"
