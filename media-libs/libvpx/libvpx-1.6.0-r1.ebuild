...
PATCHES=(
	...
	epatch "${FILESDIR}/${PV}/0005-quantize_ssse3_x86_64.asm-fix-data-heap-corruption.patch"
	epatch "${FILESDIR}/${PV}/0006-segfault-fix-unaligned-access.patch"
	epatch "${FILESDIR}/${PV}/0007-sanitizer-fix-unaligned-access.patch"
	epatch "${FILESDIR}/${PV}/0008-sanitizer-fix-unaligned-memory-access.patch"
	epatch "${FILESDIR}/${PV}/0009-sanitizer-fix-out-of-bounds-access.patch"
