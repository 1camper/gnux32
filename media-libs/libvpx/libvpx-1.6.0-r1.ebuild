...
PATCHES=(
	...
	"${FILESDIR}/${PV}/0001-Fix-segmentation-fault-caused-by-denoiser-working-wi.patch"
	...
	"${FILESDIR}/${PV}/0005-quantize_ssse3_x86_64.asm-fix-data-heap-corruption.patch"
	"${FILESDIR}/${PV}/0006-segfault-fix-unaligned-access.patch"
	"${FILESDIR}/${PV}/0007-sanitizer-fix-unaligned-access.patch"
	"${FILESDIR}/${PV}/0008-sanitizer-fix-unaligned-memory-access.patch"
	"${FILESDIR}/${PV}/0009-sanitizer-fix-out-of-bounds-access.patch"
